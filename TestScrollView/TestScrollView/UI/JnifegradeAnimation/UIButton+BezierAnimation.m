...
@implementation UIButton (BezierAnimation)
...
- (void)changeNumberBySelector {
    if (_index>= KMaxTimes) {
        ...
        [self setTitle:[NSString stringWithFormat:@"%.0f",_toNum] forState:(UIControlStateNormal)];
        ...
        [self setTitle:[NSString stringWithFormat:@"%.0f",value] forState:(UIControlStateNormal)];
